      ...
      {selected && (
        <div style={{
          ...
          <div style={{
            ...
            <strong>Recommendation:</strong> Use {selectedMethod === "mrmr" ? "mRMR" : selectedMethod === "univariate" ? "Univariate" : selectedMethod === "lasso" ? "LASSO" : "Elastic Net"} for clinical trial analysis. All methods produce comparable results; choose based on your need for interpretability (LASSO/Elastic Net) or minimal feature redundancy (mRMR).
          </div>
        </div>
      )}
