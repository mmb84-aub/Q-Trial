        ...
        def _fetch_one_cst(cst: ClinicalSearchTerm) -> GroundedFinding:
            if cst.translation_failed:
                return GroundedFinding(
                    ...
                    variable=cst.variable,
                    endpoint=cst.endpoint,
                    direction=cst.direction,
                    direction_label=cst.direction_label,
                    significant=cst.significant,
                    significance=cst.significance,
                    p_value=cst.p_value,
                    effect_size=cst.effect_size,
                    effect_size_label=cst.effect_size_label,
                    test_type=cst.test_type,
                    confidence_warning=cst.confidence_warning,
