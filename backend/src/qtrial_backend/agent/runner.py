...
def _build_initial_message(
    ...
    if column_dict:
        ...
        column_descriptions = (
            ...
            "(treat these definitions as ground truth ΓÇö do NOT ask about coding "
...
def run_statistical_agent_loop(
    ...
    console.print(
        f"[bold cyan]Γû║ Statistical Agent Loop:[/bold cyan] "
    ...
    if emit is not None:
        try:
            emit({
                ...
                "message": f"Starting iterative statistical analysis ({len(tools)} tools)ΓÇª",
            })
        except Exception:
            pass
    ...
    console.print(
        f"  [bold green]Γ£ö Agent Loop complete:[/bold green] "
