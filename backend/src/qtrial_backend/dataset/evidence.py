...
# ΓöÇΓöÇ main function ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ citation formatter ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
def format_citations(evidence: dict) -> dict[str, list[str]]:
    ...
    top_correlations  ΓåÆ INDEXED list form ONLY:
    ...
    outlier_flags     ΓåÆ dotted column key (is a dict):
        "outlier_flags.bili: count=2, pct=13.33%, fences=[-0.675, 6.675], top=[14.5, 12.6]"

    missingness_pct   ΓåÆ dotted column key:
        "missingness_pct.bili=0.0%"

    id_duplicates     ΓåÆ dotted column key:
        "id_duplicates.id: duplicate_count=0, total_non_null=15"

    cardinality       ΓåÆ dotted column key:
        "cardinality.sex=2"

    categorical_distributions ΓåÆ dotted column key:
        "categorical_distributions.sex: f=12, m=3"

    constant_columns  ΓåÆ single entry (it is a list):
        "constant_columns: []"
    """
    citations: dict[str, list[str]] = {}

    # top_correlations: INDEXED because it is a list
    # "top_correlations.albumin" is INVALID ΓÇö use "top_correlations[i]" ONLY
    corr_lines: list[str] = []
    ...
    # constant_columns: list ΓåÆ single entry
